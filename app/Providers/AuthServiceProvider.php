...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // UPDATED AFTER CREATED THE POLICIES SINCE WE ADD THE POLICY CLASSES AND WE REGISTER THEM, WE DONT NEED THESE GATES ANYMORE. BUT YOU CAN USE GATES IN SOME GENEREIC APPLICATION WIDE AUTHORIZATION CHECKS, BUT FOR RESOURCES AND MODELS, IT SUGGESTS THAT TO STICK TO THE POLICIES. 
